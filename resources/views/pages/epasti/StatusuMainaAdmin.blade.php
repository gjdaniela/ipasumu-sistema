    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td style="background-color: #FFDF00; padding: 20px; text-align: center;">
                <h1 style="color: #333;">Īpašumam <a href="{{$url}}" style="color: #333; text-decoration: none;">{{$nosaukums}}</a> tika nomainīts statuss</h1>
            </td>
        </tr>
        <tr>
            ...
            <td style=" padding: 20px;">
                ...
                <p style="font-size: 18px;"> Tagadējais īpašuma statuss: <span style="font-weight: bold;">{{ $loma}}</span></p>
                <p style="font-size: 18px;"> Iepriekšējais īpašuma statuss: <span style="font-weight: bold;">{{ $iepr_loma}}</span></p>
            </td>
        </tr>
        <tr>
